...
// idea : to build topo sort and if all vissited  -> return 1 else 0; - will  not work
//2. BFS_ keep marking vis if processde node ois vis  - return false;

// 3. DFS - keep vis each node - and if curr node found to be vis-  return false;